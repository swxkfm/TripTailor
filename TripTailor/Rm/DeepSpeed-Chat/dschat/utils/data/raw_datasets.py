...
class TravelDataset(PromptRawDataset):

    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, dataset_name)
        self.dataset_name = 'travel_dataset'
        self.dataset_name_clean = "travel_dataset"
        if os.path.exists(self.dataset_name):
            self.raw_datasets = load_from_disk(self.dataset_name)
