...
def save_hf_format(model, tokenizer, args, sub_folder=""):
    ...
    try:
        ...
        # 如果 tokenizer 没有实现 save_vocabulary，手动保存 vocab.txt 或 vocab.json
        print("save_vocabulary method not implemented. Saving vocab manually.")
        vocab = tokenizer.get_vocab()  # 获取词汇表
        vocab_file = os.path.join(output_dir, "vocab.json")  # 或者可以是 vocab.txt，取决于格式
